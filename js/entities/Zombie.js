...
export class Zombie extends Entity{
 constructor(scene,world,x,y,z){super(x,y,z);this.world=world;this.speed=1.25;this.health=20;this.attackTimer=0;this.groundTimer=0;this.groundYCache=y;this.vel.y=0;this.group=new THREE.Group();
  ...
  const e1=new THREE.Mesh(new THREE.BoxGeometry(.07,.07,.03),eye),e2=e1.clone();e1.position.set(-.13,1.62,-.28);e2.position.set(.13,1.62,-.28);this.group.add(head,body,l,r,e1,e2);this.group.position.copy(this.pos);scene.add(this.group)}
